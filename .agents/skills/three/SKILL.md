---
name: three
description: React Three Fiber and Three.js implementation rules for TSX scene code. Use when working on @react-three/fiber, drei, Canvas, useFrame, controls, scene performance, or other Three.js-heavy TSX components.
---
